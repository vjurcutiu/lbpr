...
export default function SignupPage() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      // Track conversion at account creation time
      try { trackSignupConversion({ user_id: cred.user?.uid }); } catch {}
        ...
        <div className="space-y-4 max-w-sm mx-auto">
          <form className="space-y-4" onSubmit={onSubmit}>
            ...
            <button
              ...
              className="w-full rounded-xl border border-gray-300 py-2 disabled:opacity-60"
            >
