  ...
  return (
    <div className="border-t border-border/70">
      ...
      <div
        ...
        onBlur={emitChange}
        className={cn(
          "min-h-[520px] max-w-full overflow-x-auto overscroll-x-contain px-5 py-6 text-[15px] leading-7 outline-none md:px-8 md:py-8",
          ...
          "[&_strong]:font-semibold [&_table]:my-5 [&_table]:w-max [&_table]:min-w-[1280px] [&_table]:max-w-none [&_table]:border-collapse [&_table]:text-sm",
          "[&_td]:min-w-[160px] [&_td]:max-w-[320px] [&_td]:whitespace-normal [&_td]:break-words [&_td]:border-t [&_td]:border-border/70 [&_td]:px-3 [&_td]:py-2 [&_td]:align-top [&_td]:text-sm [&_td]:leading-6 [&_td]:[overflow-wrap:anywhere]",
          "[&_th]:min-w-[160px] [&_th]:max-w-[280px] [&_th]:whitespace-normal [&_th]:break-words [&_th]:border-b [&_th]:border-border/70 [&_th]:bg-muted/30 [&_th]:px-3 [&_th]:py-2 [&_th]:text-left [&_th]:text-xs [&_th]:font-semibold [&_th]:uppercase [&_th]:tracking-[0.12em] [&_th]:text-muted-foreground [&_th]:[overflow-wrap:anywhere]",
