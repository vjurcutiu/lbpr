...
async function ensureFirebaseJson(dir) {
...
export async function exportExtensions(projectId, outDir) {
    ...
    if (stdout)
        console.log(pc.dim(stdout.split('\n').slice(-8).join('\n')));
}
export async function applyExtensions(projectId, ssotDir) {
